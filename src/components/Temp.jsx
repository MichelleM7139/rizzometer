    ...
    const animate = () => {
      ...
      if (titleRef.current) {
        ...
        spansRef.current.forEach((span) => {
          ...
          // span.style.fontVariationSettings = `'wgt' ${wght}, 'wdth' ${wdth}, 'ital' ${italVal}`;
          span.style.transform = `scale(${0.7+wdth / 300}, ${1 + (italVal - 0.5) * 0.1})`;
          // span.style.fontWeight = wght; // Still apply weight if the font supports it
